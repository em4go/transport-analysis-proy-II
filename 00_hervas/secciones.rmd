...
output: 
    ...
    toc_float:
      ...
      smooth_scroll: true
---
En este documento, vamos a clasificar cada una de las secciones censales de los distritos, según el barrio al que pertenecen, para poder obtener la renta media per cápita de cada barrio.
