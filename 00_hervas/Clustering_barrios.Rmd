...
m <- leaflet() %>% setView(lng = -0.376805, lat = 39.469907, zoom = 12) %>%
  addTiles()  %>%
...
m3 <- leaflet() %>% setView(lng = -0.376805, lat = 39.469907, zoom = 12) %>%
...
```{r}
saveRDS(m, file = "../00_marc/app_shiny_v1/app_shiny/mapas/cluster_barrios.rds")
saveRDS(m3, file = "../00_marc/app_shiny_v1/app_shiny/mapas/distrito_barrios.rds")
```
