...
faltantes <- faltantes %>% select(-c("0-15 años", "16-64 años", "65 o más",
                                     "paradas_metro", "plazas_parkings"))
...
```{r n_var_faltantes}
faltantes <- faltantes[faltantes$distrito %in% c("POBLATS DEL NORD",
                            "POBLATS DEL SUD", "POBLATS DE L'OEST", "RASCANYA"),]
