...
Una vez concluido el número de componentes y realizado el análisis, se debe proceder a la validación del modelo. Para ello, primero se evaluará la existencia de outliers extremos, que pueden afectar en gran medida al modelo y, posteriormente, se buscarán outliers moderados, que, no afectan en gran magnitud al modelo, pero si que son indicativos de si el modelo se está ajustando realmente a la realidad o no.
...
Pasando ahora a las variables que no tienen dependencias entre ellas, se observa una fuerte correlación multidimensional entre las variables mencionadas anteriormente, sobre cantidad de metros y personas y el closeness, que indica si la estación permite llegar al resto de estaciones con una menor distancia, y el número de líneas. Esto tiene sentido, ya que resulta lógico que las esaciones más centrales de la red tenga una mayor tránsito de metros y, por tanto, pasen más líneas distintas por ellas.
