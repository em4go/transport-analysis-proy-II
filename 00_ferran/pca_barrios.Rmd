...
histograma <- ggplot(info_barrios_indices, aes(x = indice_ricos)) + geom_histogram(bins = 10, fill = "mediumaquamarine", color = "black") + labs(title = "Histograma de la riqueza de los barrios", x = "Índice de riqueza", y = "Frecuencia")
...
```{r}
res.pca <- PCA(data_pca, graph = FALSE, ncp = Inf, quali.sup = "Distrito", scale.unit = TRUE,
