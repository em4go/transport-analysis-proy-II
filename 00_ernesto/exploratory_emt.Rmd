...
De aquí en adelante usaremos el servicio LAB, que es el que se usa entre semana.

```{r}
trips <- gtfs$trips %>%
  filter(service_id == "LAB")
```
...
Vamos a ver cuáles son los servicios que incluyen cada ruta.
