...
No utilizamos la columna ya definida porque no es correcta del todo, así que se va a obtener la suma de los m2 de cada barrio mediante el area de la figura geométrica.
...
Ahora, vamos a obtener la suma de las áreas de cada polígono. Los geo_shape son una estructura de datos con un punto para cada vértice del polígono, de forma que existen funciones para obtener el área del polígono.
